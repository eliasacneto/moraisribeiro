...
const Nav = () => {
    return (
      <div className="fixed w-full h-[10vh] bg-transparent overflow-hidden z-10 border-b border-[#B8967E] ">
        <div className="w-[90%] md:w-[90%] h-[100%] mx-auto flex items-center justify-between">
          ...
          <ul className="flex space-x-20 text-white ml-96 ">
          <li>
        ...
        <div>
          <Link href="/contato" className="bg-[#CC926A] text-white py-3 px-10 rounded-tl-lg rounded-br-lg px-10 py-3 hover:bg-gray-700">
            Contato
          </Link>
        </div>
        </div>
